...
import 'package:afrilingo/features/admin/services/admin_service.dart';
...
class _AdminDashboardState extends State<AdminDashboard>
  ...
  void _showEditLanguageDialog(Language language) {
    ...
    final descriptionController =
        TextEditingController(text: language.description);
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              try {
                await _adminService.updateLanguage(
                    language.id, updatedLanguage);
                Navigator.pop(context);
                _loadData(); // Refresh the list
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              final language = _languages
                  .firstWhere((lang) => lang.id == selectedLanguageId);
