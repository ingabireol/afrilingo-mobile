...
class LightThemeColors {
  ...
  static const shadowColor = Color(0xFF000000); // Shadow color for light mode
}
...
class DarkThemeColors {
  ...
  static const shadowColor = Color(0xFF000000); // Shadow color for dark mode
...
class ThemeProvider extends ChangeNotifier {
  ...
  Color get shadowColor =>
      _isDarkMode ? DarkThemeColors.shadowColor : LightThemeColors.shadowColor;
